...
public class CalendarManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //tooltips
        Managers.UI.TooltipManager.AttachTooltip(_toggleCalendarButton.gameObject, "Toggle Calendar", InputCommand.ToggleCalendar, "", true);
        Managers.UI.TooltipManager.AttachTooltip(_calendarPagePreviousButton.gameObject, "Previous Week", InputCommand.CalendarPagePrevious, "", true);
        Managers.UI.TooltipManager.AttachTooltip(_calendarPageNextButton.gameObject, "Next Week", InputCommand.CalendarPageNext, "", true);
