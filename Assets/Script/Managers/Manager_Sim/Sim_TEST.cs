...
public class Sim_TEST : MonoBehaviour
{
    ...
    private void SIM_TestPopup01(DateTime triggerDate)
    {
        ...
        SimAction simAction = new SimAction(SimActionID.Test_Popup01, npcs, validCondition, delayCondition, null, null, "", "", popupConfig);
    ...
    private void SIM_TestPopup02(DateTime triggerDate)
    {
        ...
        SimAction simAction = new SimAction(SimActionID.Test_Popup02, npcs, validCondition, delayCondition, null, null,"", "", popupConfig);
    ...
    private void SIM_TestPopup03(DateTime triggerDate)
    {
        ...
        SimAction simAction = new SimAction(SimActionID.Test_Popup03, npcs, validCondition, delayCondition, initialAction, null, "", "", popupConfig);
    ...
    private void SIM_TestPopup04(DateTime triggerDate)
    {
        ...
        SimAction simAction = new SimAction(SimActionID.Test_Popup04, npcs, validCondition, delayCondition, initialAction, null, "", "", popupConfig);
    ...
    private void SIM_TestPopup05()
    {
        ...
        SimAction simAction = new SimAction(SimActionID.Test_Popup05, npcs, validCondition, delayCondition, initialAction, null, "", "", popupConfig);
    ...
    private void SIM_TestPopup05_option01()
    {
        ...
        SimAction simAction = new SimAction(SimActionID.Test_Popup05_1, npcs, validCondition, delayCondition, null, null, "", "", popupConfig);
    ...
    private void SIM_TestPopup05_option02()
    {
        ...
        SimAction simAction = new SimAction(SimActionID.Test_Popup05_2, npcs, validCondition, delayCondition, null, null, "", "", popupConfig);
        SimEvent_Immediate SimEvent_Immediate = new SimEvent_Immediate(simAction);
    }
    ...
    private void SIM_ScheduleTravel(SimActionID simActionID, List<int> npcs, DateTime triggerDate, CityName city)
    {
        Func<string> validCondition = () => { return ""; };
        Func<bool> delayCondition = () => { return false; };
        SimAction_PopupConfig popupConfig = new SimAction_PopupConfig(null, false, "Test Travel Event", "This is a test travel event that is scheduled to fire on " + triggerDate.ToShortDateString() + " at 8:30AM - but not pause time.  The even will last for one hour.", Asset_png.Popup_Vinyl, Asset_wav.event_generic);
        SimAction simAction = new SimAction(simActionID, npcs, validCondition, delayCondition, null, null, "", "", popupConfig);
        SimEvent_Scheduled SimEvent_Scheduled01 = new SimEvent_Scheduled(simAction, triggerDate);
    }
    private void SIM_ScheduleProduction(SimActionID simActionID, List<int> npcs, DateTime triggerDate)
    {
        ...
        SimAction simAction = new SimAction(simActionID, npcs, validCondition, delayCondition, null, duration, "Producing", "Will Produce", popupConfig);
        SimEvent_Scheduled SimEvent_Scheduled01 = new SimEvent_Scheduled(simAction, triggerDate);
    }
    private void SIM_ScheduleGig(SimActionID simActionID, List<int> npcs, DateTime triggerDate)
    {
        ...
        SimAction simAction = new SimAction(simActionID, npcs, validCondition, delayCondition, null, duration, "Gigging", "Will Gig", popupConfig);
        SimEvent_Scheduled SimEvent_Scheduled01 = new SimEvent_Scheduled(simAction, triggerDate);
    }
